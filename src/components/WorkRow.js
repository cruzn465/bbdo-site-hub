...
function WorkRow(props) {
  const { posts, media, setModalShow, setPost, setSelectedMedia, mediaObj } = props;
  console.log(posts);
          ...
          <React.Fragment>
            <div
              className="outer-container pointer"
               onClick={(e) => handleClick(e, postCurArr[0],findSourceUrl(postCurArr[0]))}
            >
              <div className="work-col" style={{ backgroundImage: `url(${findSourceUrl(postCurArr[0])})` }}></div>
              <div className="red abs-cont">
                <h2 className="post-titles cap">{decode(postCurArr[0].title.rendered)}</h2>
              </div>
            ...
            >
              <div className="work-col" style={{ backgroundImage: `url(${findSourceUrl(postCurArr[1])})` }}></div>
              <div className="red abs-cont">
                <h2 className="post-titles cap">{decode(postCurArr[1].title.rendered)}</h2>
              </div>
            </div>
            <div
              className="outer-container pointer"
            ...
            >
              <div className="work-col" style={{ backgroundImage: `url(${findSourceUrl(postCurArr[2])})` }}></div>
              <div className="red abs-cont">
                <h2 className="post-titles cap">{decode(postCurArr[2].title.rendered)}</h2>
              </div>
            </div>
          </React.Fragment>
        );
